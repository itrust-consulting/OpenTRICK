	...
	var Slider = function(element, options) {
		...
		this.picker = $(
				'<div class="slider">' + '<div class="slider-track">' + '<div class="slider-selection"></div>' + '<div class="slider-handle"></div>'
						+ '<div class="slider-handle"></div>' + '</div>' + '<div class="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>'
		...
		if (this.orientation == 'vertical')
			this.percentage = [ 100 - this.percentage[0], this.range ? 100 - this.percentage[1] : this.percentage[1], this.percentage[2] ];
	...
	Slider.prototype = {
		...
		layout : function() {
			...
			if (this.range) {
				...
				this.tooltip[0].style[this.stylePos] = this.size * (this.percentage[0] + (this.percentage[1] - this.percentage[0]) / 2) / 100
						- (this.orientation === 'vertical' ? this.tooltip.outerHeight() / 2 : this.tooltip.outerWidth() / 2) + 'px';
			} else {
		...
		calculateValue : function() {
			...
			if (this.range) {
				if (this.orientation === 'vertical')
					val = [ (this.min + Math.round((this.diff * (100 - this.percentage[0]) / 100) / this.step) * this.step),
							(this.min + Math.round((this.diff * (100 - this.percentage[1]) / 100) / this.step) * this.step) ];
				else
