...
function analysisTableSortable() {
	...
	$("th[class~='tablesorter-header'][data-column='4']").css({'width':'150px'});
	$("th[class~='tablesorter-header'][data-column='5']").css({'width':'250px'});
	$("th[class~='tablesorter-header'][data-column='6']").css({'width':'150px'});
	$("th[class~='tablesorter-header'][data-column='7']").css({'width':'50px'});
	return false;
}