...
<div class="col-lg-10 col-md-9 trick-ui" id="section_scenario_assessment" data-view-type='table' data-view-name='estimation-ui' data-trick-asset-id='-1'
		...
		<tbody>
			...
			<c:if test="${type.quantitative}">
				<tr class="panel-footer" style="font-weight: bold;">
					<c:choose>
						<c:when test="${show_uncertainty}">
							<td colspan="${impactTypes.size() +  4 }"><spring:message code="label.total.ale" /></td>
