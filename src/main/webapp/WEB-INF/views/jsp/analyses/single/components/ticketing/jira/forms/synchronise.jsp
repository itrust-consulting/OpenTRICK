...
<div class="modal fade" id="modal-ticketing-synchronise" tabindex="-1" role="dialog" data-aria-labelledby="modalTicketingSynchronise" data-aria-hidden="true" data-backdrop="static">
	<c:choose>
		<c:when test="${empty measures or empty tasks }">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-body">
						<spring:message code='info.no.data.to.display' text="Measure are still linked to another project, please unlink all selected measures"/>
					</div>
