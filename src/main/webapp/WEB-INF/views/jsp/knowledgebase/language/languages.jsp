...
<div class="tab-pane" id="tab-language">
	<div class="section" id="section_language">
		<ul class="nav nav-pills bordered-bottom" id="menu_language">
			<li data-trick-ignored="true"><a href="#" onclick="return newLanguage();"><span class="glyphicon glyphicon-plus primary"></span> <spring:message code="label.action.add" text="Add" /> </a></li>
