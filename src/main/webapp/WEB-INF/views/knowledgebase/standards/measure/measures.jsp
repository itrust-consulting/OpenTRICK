...
<div id="measures_header">
	...
	<input type="hidden" id="idStandard" value="${standard.id}" /> <input type="hidden" id="standardLabel" value="${standard.label}" /> <input type="hidden" id="standardVersion"
	...
	<div class="row" style="margin-top: 5px; margin-bottom: -15px">
		...
		<div class="col-md-1${!empty languages?'1':'2'}">
			<ul class="nav nav-pills" id="menu_measure_description">
				...
				<li class="disabled pull-right" data-trick-selectable="true"><a href="#" class="text-danger" onclick="return deleteMeasure();"><span
						class="glyphicon glyphicon-remove"></span> <spring:message code="label.menu.delete.norm" text="Delete" /> </a></li>
			</ul>
		</div>
	</div>
</div>
