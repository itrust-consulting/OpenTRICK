...
<div class="modal fade" id="addNormModel" tabindex="-1" role="dialog" data-aria-labelledby="addNewNorm" data-aria-hidden="true">
...
<div class="modal fade" id="deleteNormModel" tabindex="-1" data-aria-hidden="true" data-aria-labelledby="deleteNorm" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" data-aria-hidden="true">&times;</button>
