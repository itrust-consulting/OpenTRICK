	...
	<div id="wrap">
		...
		<div class="container">
			...
			<div class="content" id="content">
				...
				<a href="../../Display"><spring:message
						code="menu.navigate.back" /></a>|<a href="Add"><spring:message
						code="label.measure.add.menu" /></a>
					...
					<table class="table">
						...
						<c:forEach items="${measureDescriptions}" var="measureDescription">
							<tr>
								...
								<td><a href="Edit/${measureDescription.id}"><spring:message
											code="label.action.edit" /></a>| <a
									href="Delete/${measureDescription.id}"><spring:message
