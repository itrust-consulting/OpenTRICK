	...
	<div id="wrap">
		...
		<div class="container">
			...
			<div class="content" id="content">
				...
				<a href="../Measures/Display"><spring:message code="menu.navigate.back" /></a>
				<form:errors cssClass="error" element="div" />
				<form:form method="post" action="Create" commandName="measureDescription">
					<table class="table">
						<tr>
						...
						<tr>
							<td colspan="2"><input type="submit" value="<spring:message code="label.measure.add.form"/>" /></td>
						</tr>
					</table>
				</form:form>
			</div>
