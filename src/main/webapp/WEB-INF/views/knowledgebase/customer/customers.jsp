...
<div class="section" id="section_customer">
	<div class="page-header">
		<h3 id="Customers">
			<spring:message code="title.menu.knowledgebase.customers" text="Customers"/>
		</h3>
	</div>
			...
			<ul class="nav nav-pills" id="menu_customer">
				...
				<c:if test="${!empty(adminView)}">
					<sec:authorize access="hasAnyRole('ROLE_ADMIN', 'ROLE_SUPERVISOR')">
						<li class="disabled" data-trick-selectable="true"><a href="#" onclick="return manageUsers();"><span class="glyphicon glyphicon-remove"></span> <spring:message
					...
					<table class="table">
						...
						<tbody>
							<c:forEach items="${customers}" var="customer">
								<tr data-trick-id="${customer.id}" ondblclick="return editSingleCustomer('${customer.id}');">
