...
<!-- #################################################################### Analysis Menu ################################################################### -->		
	...
	<h1><spring:message code="label.history.title" /></h1>
		...
		<table class="data" border="1">
			...
			<c:forEach items="${histories}" var="history">
				<tr>
					...
					<td><a href="Edit/${history.id}"><spring:message code="label.action.edit" /></a>|<a href="Delete/${history.id}"><spring:message code="label.action.delete" /></a></td>
				</tr>
			</c:forEach>
		</table>
	</c:if>
	<c:if test="${empty histories}">
	<h4><spring:message code="label.history.notexist" /></h4>	
	</c:if>
</div>
