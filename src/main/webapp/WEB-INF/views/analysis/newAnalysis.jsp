...
<div id="form_add_analysis">
		...
		<div class="col-sm-10" id="analysiscustomercontainer">
			<select name="analysiscustomer">
				<option value="-1" selected="selected"><spring:message
						code="label.action.choose" text="Choose ..." />
	...
	<div class="form-group">
		<label for="profile" class="col-sm-2 control-label"> <spring:message
				code="label.analysis.profileAnalysis" text="Profile" />
		</label>
		<div class="col-sm-10">
			<select name="profile" id="analysis_profile">
				<option value="-1"><spring:message
						code="label.select.analysisProfile" text="Select a profile" /></option>
				<c:forEach items="${profiles}" var="profile">
					<option value="${profile.id }"><spring:message
							text="${profile.identifier}" /></option>
				</c:forEach>
			</select>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-10">
			<textarea name="label" id="analysis_label" class="form-control"></textarea>
		</div>
	</div>
	<div class="form-group">
		<label for="author" class="col-sm-2 control-label"> <spring:message
				code="label.analysis.author" text="Author" />
		</label>
		<div class="col-sm-10">
