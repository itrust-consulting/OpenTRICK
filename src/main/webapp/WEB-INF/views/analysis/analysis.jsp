								...
								<div class="panel-heading" style="min-height: 60px">
									<ul class="nav nav-pills" hidden="true" id="menu_analysis">
										...
										<li trick-selectable="true"><a href="#" onclick="return selectAnalysis(undefined, 'true')"> <span class="glyphicon glyphicon-pushpin"></span> <spring:message
													code="label.analysis.pin" text="Edit Analysis" />
										</a></li>
										...
										<li trick-selectable="true"><a href="#" onclick="return exportAnalysis()"> <span class="glyphicon glyphicon-download-alt"></span> <spring:message
													code="label.analysis.export" text="Export" />
										</a></li>
										<li trick-selectable="multi"><a href="#" onclick="return calculateActionPlan()"> <span class="glyphicon glyphicon-list"></span> <spring:message
													code="label.analysis.compute.action_plan" text="Compute action plan" />
										</a></li>
										<li trick-selectable="multi"><a href="#" onclick="return calculateRiskRegister()"> <span class="glyphicon glyphicon-list-alt"></span> <spring:message
													code="label.analysis.compute.risk_register" text="Compute risk register" />
										</a></li>
									</ul>
								</div>
