				...
				<c:choose>
					...
					<c:otherwise>
						<div class="section" id="section_analysis">
							...
							<div class="panel panel-default" onmouseover="if(!$('#menu_analysis').is(':visible')) {updateMenu('#section_analysis', '#menu_analysis');$('#menu_analysis').show();}"
								 onmouseout="$('#menu_analysis').hide();">
								
								<div class="panel-heading" style="min-height: 60px">
									<ul class="nav nav-pills" hidden="true" id="menu_analysis">
										<li>
											<a href="#" onclick="return newAnalysis();">
												<span class="glyphicon glyphicon-plus primary"></span> <spring:message code="label.analysis.add" text="New analysis" /> 
											</a>
										</li>
										<li trick-selectable="true">
											<a href="#" onclick="return selectAnalysis(undefined, 'true')">
												<span class="glyphicon glyphicon-pushpin"></span> <spring:message code="label.analysis.pin" text="Edit Analysis" /> 
											</a>
										</li>
										<li trick-selectable="true">
											<a href="#" onclick="return addHistory()">
												<span class="glyphicon glyphicon-new-window"></span> <spring:message code="label.analysis.create.new_version" text="Create new version" />
											</a>
										</li>
										<li trick-selectable="true">
											<a href="#" onclick="return editSingleAnalysis();">
											<span class="glyphicon glyphicon-edit danger"></span> <spring:message
										...
										<li trick-selectable="true">
										<a href="#" onclick="return exportAnalysis()">
										<span class="glyphicon glyphicon-download-alt"></span> <spring:message
													code="label.analysis.export" text="Export" /> </a></li>
										<li trick-selectable="multi">
										<a href="#" onclick="return calculateActionPlan()">
										<span class="glyphicon glyphicon-list"></span> <spring:message
													code="label.analysis.compute.action_plan" text="Compute action plan" /> </a></li>
										<li trick-selectable="multi">
										<a href="#" onclick="return calculateRiskRegister()">
