						...
						<tbody>
							<c:forEach items="${extendedParameters[0]}" var="parameter" varStatus="status">
								<tr trick-class="ExtendedParameter" trick-id="${parameter.id}">
									...
									<td trick-field="acronym" trick-field-type="string" class="success" trick-callback="updateAssessmentAcronym('${parameter.id}')" ondblclick="return editField(this);"><spring:message
											text="${parameter.acronym}" /></td>
									<td trick-field="description" trick-field-type="string" class="success" ondblclick="return editField(this);"><spring:message text="${parameter.description}" /></td>
						...
						<tbody>
							<c:forEach items="${simpleParameters[2]}" var="parameter">
								<tr trick-class="Parameter" trick-id="${parameter.id}">
									...
									<td trick-field="value" trick-field-type="double" class="success" ondblclick="return editField(this);"><fmt:formatNumber value="${parameter.value}"
						...
						<tbody>
							<tr>
								<c:forEach items="${simpleParameters[0]}" var="parameter">
									<td trick-class="Parameter" trick-id="${parameter.id}" class="success" trick-field="value" trick-field-type="double" ondblclick="return editField(this);"><fmt:formatNumber
