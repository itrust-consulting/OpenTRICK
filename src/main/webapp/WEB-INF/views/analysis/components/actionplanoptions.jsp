...
<form action="${pageContext.request.contextPath}/ActionPlan/Compute" method="post" class="form-horizontal" id="actionplancomputationoptionsform">
	...
	<spring:message code="title.options.selectnorm" text="<p>Select a norm to compute the action plan</p><p>(No options given means: all norms will be used to compute)</p>"></spring:message>
	...
	<table class="table">
		<tbody>
			<tr>
				<td><spring:message code="title.options.uncertainty" text="<p>Optimistic and pessimistic computation</p>" /></td>
