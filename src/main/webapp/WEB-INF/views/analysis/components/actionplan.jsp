...
<div class="section" id="section_actionplans">
	...
	<div class="panel panel-default" onmouseover="if(!$('#menu_actionplan').is(':visible')) {$('#menu_actionplan').show();}" onmouseout="$('#menu_actionplan').hide();">
		<div class="panel-heading" style="min-height: 60px;">
			<div class="col-md-10">
				<ul class="nav nav-pills">
					<c:forEach items="${actionplansplitted.keySet()}" var="apt" varStatus="status">
						<li ${status.index==0? "class='disabled'" : ""} trick-nav-control="${apt}"><a href="#" onclick="hideActionplanAssets('#section_actionplans', '#menu_actionplan');return navToogled('section_actionplans','${apt}')">
			...
			<div class="col-md-2">
				<ul class="nav nav-pills" hidden="true" id="menu_actionplan">
					<li>
