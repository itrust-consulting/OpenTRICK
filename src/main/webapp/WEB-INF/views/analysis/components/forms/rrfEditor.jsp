							...
							<c:if test="${!empty(selectedScenario)}">
								...
								<table class="table">
									...
									<tbody>
										...
										<tr>
											<c:forEach items="${assetTypes}" var="assetType">
												<td class="warning" trick-class="AssetType"><input type="text" id='scenario_assetType_<spring:message text="${assetType.type}"/>_value' style="min-width: 50px;"
													readonly="readonly" class="form-control" value="0" name="<spring:message text="${assetType.type}" />"></td>
											</c:forEach>
					...
					<div class="panel-body">
						<div style="overflow: auto;">
							<table class="table">
								...
								<tbody>
									<tr>
										<td class="warning"><input type="text" class="slider" id="measure_fmeasure" value="0" data-slider-min="0" data-slider-max="10" data-slider-step="1"
										...
										<td class="warning"><input type="text" class="slider" id="measure_fSectoral" value="0" data-slider-min="0" data-slider-max="4" data-slider-step="1"
									...
									<tr>
										<td class="warning"><input type="text" readonly="readonly" class="form-control" id="measure_fmeasure_value" value="0" name="fmeasure"></td>
										<td class="warning"><input type="text" readonly="readonly" class="form-control" id="measure_fSectoral_value" value="0" name="fsectoral"></td>
										<c:forEach items="${categories}" var="category">
