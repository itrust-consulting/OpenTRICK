		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="phaseNewModal-title">
					<spring:message code="label.phase.${empty(phase)? 'add':'edit'}"
						text="${empty(phase)? 'Add new phase':'Edit phase'}" />
				</h4>
			</div>
			<div class="modal-body">
				<form name="phase"
					action="${pageContext.request.contextPath}/Phase/Save"
					class="form-horizontal" id="phase_form">
					<c:choose>
					...
					<div class="form-group">
						<label for="beginDate" class="col-sm-2 control-label"> <spring:message
								code="label.begin.date" text="Begin" />
						</label>
						<div class="col-sm-10">
							<div class="input-group">
								<input name="beginDate" id="phase_begin_date"
									class="form-control" type="date"
									value="${empty(phase)? '':phase.beginDate}"
					...
					<div class="form-group">
						<label for="endDate" class="col-sm-2 control-label"> <spring:message
								code="label.phase.end_date" text="End" />
						</label>
						<div class="col-sm-10">
							<div class="input-group">
								<input name="endDate" id="phase_endDate" class="form-control"
									type="date"
									placeholder='<spring:message code="label.phase.date.pattern" text="YYYY-MM-DD"/>'
