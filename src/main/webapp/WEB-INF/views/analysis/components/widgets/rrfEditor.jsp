								...
								<table class="table">
									...
									<tbody>
										<tr>
											...
											<td class="warning" trick-type="source"><input
												type="text" class="slider" id="scenario_environmental"
											...
											<td class="warning" trick-type="source"><input
												type="text" class="slider" id="scenario_internalThreat"
											...
											<td class="warning" trick-type="source"><input
												type="text" class="slider" id="scenario_externalThreat"
										...
										<tr>
											...
											<td class="warning" trick-type="source"><input
												type="text" readonly="readonly" class="form-control"
												id="scenario_environmental_value"
												value="${selectedScenario.environmental}"></td>
											<td class="warning" trick-type="source"><input
												type="text" readonly="readonly" class="form-control"
												id="scenario_internalThreat_value"
												value="${selectedScenario.internalThreat}"></td>
											<td class="warning" trick-type="source"><input
												type="text" readonly="readonly" class="form-control"
												id="scenario_externalThreat_value"
					...
					<div class="panel-body">
						<div style="overflow: auto;">
							<table class="table">
								...
								<tbody>
									<tr>
										<td class="success"><input type="text"
									...
									<tr>
										<td class="success"><input type="text"
											readonly="readonly" class="form-control"
											id="measure_preventive_value" value="0" name="preventive"></td>
										<td class="success"><input type="text"
											readonly="readonly" class="form-control"
											id="measure_limitative_value" value="0" name="limitative"></td>
										<td class="success"><input type="text" value="0"
											readonly="readonly" class="form-control"
											id="measure_detective_value" name="detective"></td>
										<td class="success"><input type="text"
											readonly="readonly" class="form-control"
											id="measure_corrective_value" value="0" name="corrective">
										</td>
										<td class="warning"><input type="text"
											readonly="readonly" class="form-control" value="0"
											id="measure_intentional_value" name="intentional"></td>
										<td class="warning"><input type="text"
											readonly="readonly" class="form-control"
											id="measure_environmental_value" value="0"
											name="environmental"></td>
										<td class="warning"><input type="text"
											readonly="readonly" class="form-control"
											id="measure_internalThreat_value" value="0"
											name="internalThreat"></td>
										<td class="warning"><input type="text"
											readonly="readonly" class="form-control" value="0"
											id="measure_externalThreat_value" name="externalThreat"></td>

										<td class="success"><input type="text"
											readonly="readonly" class="form-control"
											id="measure_fmeasure_value" value="0" name="fmeasure"></td>
