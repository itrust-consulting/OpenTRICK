	...
	<div class="modal-dialog">
		<div class="modal-content">
				...
				<form name="history"
					...
					<div class="form-group">
						...
						<spring:hasBindErrors name="history">
							<spring:bind path="history.author" ignoreNestedPath="true"
								htmlEscape="true">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input id="history_oldVersion" class="form-control"
								value="${oldVersion}" readonly />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<spring:hasBindErrors name="history">
								<spring:bind path="history.version" ignoreNestedPath="true"
									htmlEscape="true">
									<c:forEach items="${status.errorMessages}" var="error">
										<label class="label label-danger"> <c:out
												value="${error}" />
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							<spring:hasBindErrors name="history">
								<spring:bind path="history.comment" ignoreNestedPath="true"
									htmlEscape="true">
									<c:forEach items="${status.errorMessages}" var="error">
										<label class="label label-danger"> <c:out
												value="${error}" />
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" id="history_submit_button"
