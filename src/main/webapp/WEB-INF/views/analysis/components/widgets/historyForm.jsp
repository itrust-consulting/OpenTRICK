...
<div class="modal fade" id="addHistoryModal" tabindex="-1" role="dialog" aria-labelledby="addhistoryLabel" aria-hidden="true">
			...
			<div class="modal-body">
				...
				<spring:hasBindErrors name="history">
					<div class="alert alert-danger">
						<spring:bind path="history.*" ignoreNestedPath="true" htmlEscape="true">
				...
				<form name="history" action="${pageContext.request.contextPath}/History/Analysis/${analysisId}/NewVersion/Save" class="form-horizontal" id="history_form" method="post">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input name="author" id="history_author" class="form-control" value="${empty(history)? '':history.author}" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input name="version" id="history_version" class="form-control" value="${empty(history)? '':history.version}" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea name="comment" class="form-control" id="history_comment">${empty(history)? '': history.comment}</textarea>
						</div>
					</div>
				</form>
