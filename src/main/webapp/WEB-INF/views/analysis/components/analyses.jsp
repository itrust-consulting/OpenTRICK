			...
			<table class="table table-hover">
				...
				<tbody>
					<c:forEach items="${analyses}" var="analysis">
						<tr trick-id="${analysis.id}" trick-rights-id="0"
...
<jsp:include page="widgets/historyForm.jsp" />
