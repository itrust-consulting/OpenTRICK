	...
	<div class="panel panel-default">
		<div class="panel-body" style="max-height: 700px; overflow: auto;">
			<table class="table table-hover">
				<thead>
					<tr>
						<th colspan="2"><spring:message code="label.assessment.asset"
								text="Asset" htmlEscape="true" /></th>
						<th><spring:message code="label.assessment.asset.value"
								text="Asset value" htmlEscape="true" /></th>
				...
				<tbody>
					...
					<tr class="panel-footer" style="font-weight: bold;">
						...
						<td><spring:htmlEscape defaultHtmlEscape="true">
								<fmt:formatNumber value="${alep.value}" maxFractionDigits="3"
									minFractionDigits="3" />
							</spring:htmlEscape></td>
						<td><spring:htmlEscape defaultHtmlEscape="true">
								<fmt:formatNumber value="${ale.value}" maxFractionDigits="3"
									minFractionDigits="3" />
							</spring:htmlEscape></td>
						<td><spring:htmlEscape defaultHtmlEscape="true">
								<fmt:formatNumber value="${aleo.value}" maxFractionDigits="3"
									minFractionDigits="3" />
							</spring:htmlEscape></td>
						<td colspan="6" />
					</tr>
