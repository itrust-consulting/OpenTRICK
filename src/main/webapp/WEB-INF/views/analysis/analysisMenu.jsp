	...
	<div id="analysismenu" class="container" role="navigation">
		<ul class="nav navbar-nav">
			<c:if test="${!KowledgeBaseView}">
				<li><a href="#History"><spring:message code="menu.analysis.history" text="History" /></a></li>
			</c:if>
			...
			<li class="dropdown-submenu">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown"> <spring:message code="menu.analysis.standards" text="Standard" /><span class="caret"></span></a> 
				...
				<ul class="dropdown-menu">
					<c:forEach items="${measureSplited.keySet()}" var="norm">
						<li><a href="#section_measure_${norm}"> <spring:message code="menu.measure.${norm}" text="${norm}" /></a>
					</c:forEach>
				</ul>
				</c:if>
			</li>
			<c:if test="${!KowledgeBaseView }">
				...
				<li><a href="#Summary"> <spring:message code="menu.analysis.Summary" text="Action Plan Summaries" /></a></li>
				<li><a href="#RiskRegister"> <spring:message code="menu.analysis.riskregister" text="Risk Register" /></a></li>
			</c:if>
			<c:if test="${!KowledgeBaseView }">
				<li class="dropdown-submenu"><a href="#" class="dropdown-toggle" data-toggle="dropdown"> <spring:message code="menu.analysis.chart" text="Charts" /><span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="#chart_asset"> <spring:message code="label.chart.asset" text="ALE by Asset/Asset Type" /></a></li>
						<li><a href="#chart_scenario"> <spring:message code="label.chart.scenario" text="ALE by Scenario/Scenario Type" /></a></li>
						<li><a href="#chart_compliance"> <spring:message code="label.chart.compliance" text="Compliance by Standard" /></a></li>
						<li><a href="#chart_evolution"> <spring:message code="label.chart.evolution" text="Evolution of Profitability by Action Plan" /></a></li>
						<li><a href="#chart_budget"> <spring:message code="label.chart.bufget" text="Budget by Action Plan" /></a></li>
					</ul>
				</li>
