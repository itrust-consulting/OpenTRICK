...
<div class="navbar navbar-default navbar-static-top navbar-custom">
	<div id="analysismenu" class="container" role="navigation">
		...
		<ul class="nav navbar-nav">
			...
			<li><a href="#ItemInformation"> <spring:message code="menu.analysis.iteminformation" text="Item Information" />
			</a></li>
			<li><a href="#Parameter"> <spring:message code="menu.analysis.parameter" text="Parameters" />
			</a></li>
			<li><a href="#Asset"> <spring:message code="menu.analysis.asset" text="Assets" />
			</a></li>
			<li><a href="#Scenario"> <spring:message code="menu.analysis.scenario" text="Scenarios" />
			</a>
			...
			<!-- 
				<ul class="nav">
				 ...
				 -->
			<li class="dropdown"><a href="#Measure" class="dropdown-toggle"> <spring:message code="menu.analysis.measure" text="Measures" />
			</a>
				<ul class="dropdown-menu dropdown-features">
					<li><a href="#Measure_27001"> <spring:message code="menu.measure.27001" text="27001" />
					</a></li>
					<li><a href="#Measure_27002"> <spring:message code="menu.measure.27002" text="27002" />
					</a></li>
					<li><a href="#Measure_Maturity"> <spring:message code="menu.measure.maturity" text="Maturity" />
					</a></li>
					<li><a href="#Measure_Custom"> <spring:message code="menu.measure.custom" text="Custom" />
					</a></li>
				</ul></li>
			<li><a href="#ActionPlan"> <spring:message code="menu.analysis.actionplan" text="Action Plans" />
			</a></li>
			<li><a href="#Phase"> <spring:message code="menu.analysis.phase" text="Phases" />
			</a></li>
			...
			<li class="dropdown-submenu"><a href="#" class="dropdown-toggle" data-toggle="dropdown"> <spring:message code="label.action" text="Action" /><span class="caret"></span>
				...
				<ul class="dropdown-menu">
					...
					<li><a href="#"> <spring:message code="label.analysis.compute.riskRegister" text="Compute Registers" />
					</a></li>
					<li class="divider"></li>
					<li><a href="#" onclick="return wipeAssessment();"> <spring:message code="label.analysis.assessment.wipe" text="Wipe assessments" />
					</a>
					<li class="divider"></li>
					<li><a href="#" onclick="return reloadCharts();"> <spring:message code="label.analysis.charts.reload" text="Reload Charts" />
					</a>
				</ul></li>
		</ul>
	</div>
