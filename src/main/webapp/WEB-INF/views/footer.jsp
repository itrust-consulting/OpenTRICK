...
<div id="footer" class="navbar navbar-inverse navbar-fixed-bottom" style="height: 38px;min-height:30px">
	<div class="container">
		...
		<p class="text-muted credit text-center" style="margin-bottom: 10px; margin-top: 10px;"><span class="pull-left"><a href="?lang=fr" role="changeUILanguage">Français</a> | <a href="?lang=en" role="changeUILanguage">English</a></span> &copy; ${fn:replace(copyRight,'{0}',year)}
