...
<div id="footer" class="navbar navbar-inverse navbar-fixed-bottom" style="height: 38px;min-height:30px">
	<div class="container">
		...
		<p class="text-muted credit text-center" style="margin-bottom: 10px; margin-top: 10px;">&copy; <spring:message code="label.copy_right.text" arguments="${year}" text="2007-${year} itrust consulting - All Rights Reserved"/>
