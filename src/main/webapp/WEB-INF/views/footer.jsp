...
<div id="footer" class="navbar navbar-inverse navbar-fixed-bottom" style="height: 38px; min-height: 30px">
	<div class="container" style="height: 100%;">
		...
		<div class="pull-left" style="width: 25%;">
			...
			<c:choose>
				...
				<c:when test="${languagecode.getISO3Language()=='fra'}">
   				...
   				<a role="changeUILanguage" style="color: #c3c3c3; display: inline-block; padding: 5px; margin-top: 5px;"><img src="<spring:url value="/images/flags/fr_disabled.png" />" />
						Français</a>
				</c:when>
			</c:choose>
		</div>
		...
		<div class="pull-right" style="color: white; float: right; width: 25%; text-align: right; margin-top: 10px;">
			v
