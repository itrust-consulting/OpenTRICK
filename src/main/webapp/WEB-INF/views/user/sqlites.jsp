		...
		<tbody>
			<c:forEach items="${sqlites}" var="sqlite">
				<tr>
					...
					<td>
						<a class="btn btn-primary" href="${pageContext.request.contextPath}/Analysis/Sqlite/${sqlite.id}/Download" title='<spring:message code="label.action.download" text="Download"/>'><i class="fa fa-download"></i></a>
						<a class="btn btn-danger" href="${pageContext.request.contextPath}/Analysis/Sqlite/${sqlite.id}/Delete" title='<spring:message code="label.action.delete" text="Delete"/>'><i class="fa fa-trash"></i></a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
