	...
	<div class="container">
		...
		<div style="margin: 0 auto; max-width: 600px; padding: 0px 15px">
			...
			<form id="registerform" name="registerform" class="form-horizontal" method="post" action="${pageContext.request.contextPath}/DoRegister"
				onsubmit="return register('registerform')">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<select class="form-control" id="locale" name="locale" id="locale">
							<option value="en" class="list-group-item pull-left"
								style="margin-right: 5px;background: white url(${pageContext.request.contextPath}/images/flags/en.png) no-repeat 1%;border:1px solid white;padding:0px;padding-top:3px;padding-bottom:3px;padding-left: 25px;">
								English</option>
							<option value="fr" class="list-group-item pull-left"
								style="margin-right: 5px;background: white url(${pageContext.request.contextPath}/images/flags/fr.png) no-repeat 1%;border:1px solid white;padding:0px;padding-top:3px;padding-bottom:3px;padding-left: 25px;">
								Français</option>
						</select>
					</div>
				</div>
