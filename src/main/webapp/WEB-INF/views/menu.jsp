		...
		<div class="collapse navbar-collapse">
							...
							<c:when test="${!empty(sessionScope.selectedAnalysis)}">
								<li tabindex="-1" class="dropdown-submenu">
									...
									<ul class="dropdown-menu sm">
										<li>
											<a href="${pageContext.request.contextPath}/Analysis/${sessionScope.selectedAnalysis}/Select">
												<spring:message code="label.analysis.release" text="Release analysis" />
											</a>
										</li>
									</ul>
								</li>
					...
					<c:otherwise>
						<c:choose>
							<c:when test="${!empty(sessionScope.selectedAnalysis)}">
								<li tabindex="-1">
									<a href="${pageContext.request.contextPath}/Analysis"> 
										<spring:message code="label.menu.analysis.all" text="Analysis" /> <span class="badge pull-right">1</span>
									</a>
								</li>
							</c:when>
							<c:otherwise>
			...
			<ul class="nav navbar-nav navbar-right">
				<li ${menu.equals("Admin")? "class='active'" : "" }>
					<a href="${pageContext.request.contextPath}/Admin"> <spring:message code="label.administration" text="Admin" /></a>
				</li>
				<li>
