...
<ul>
	...
	<li>
		<a href="${pageContext.request.contextPath}/analysis/all" ${menu.equals("analysis/all")? "id='active'" : "" }>
			<spring:message	code="label.menu.analysis.all" text="Analysis" />
		</a>
	</li>
	<li>
		<a href="${pageContext.request.contextPath}/import/analysis" ${menu.equals("import/analysis")? "id='active'" : "" }>
