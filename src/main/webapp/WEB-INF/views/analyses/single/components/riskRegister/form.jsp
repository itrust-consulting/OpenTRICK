	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form class='form form-horizontal' name='filter'>
					<div class='form-group'>
						...
						<label class='label-control col-xs-6'><spring:message code="label.parameter.simple.cssf.impact_threshold" /></label>
						<div class='col-xs-3'>
							<select name="impact">
					...
					<div class='form-group'>
						...
						<label class='label-control col-xs-6'><spring:message code="label.parameter.simple.cssf.probability_threshold" /></label>
						<div class='col-xs-3'>
					...
					<div class='form-group'>
						<label class='label-control col-xs-6'><spring:message code="label.parameter.simple.cssf.direct_size" /></label>
					...
					<div class='form-group'>
						...
						<label class='label-control col-xs-6'><spring:message code="label.parameter.simple.cssf.indirect_size" /></label>
						<div class='col-xs-3'>
							<select name="indirect">
					...
					<div class='form-group'>
						...
						<label class='label-control col-xs-6'><spring:message code="label.parameter.simple.cssf.cia_size" /></label>
						<div class='col-xs-3'>
							<select name="cia">
					...
					<div class='form-group'>
						<label class='label-control col-xs-6'><spring:message code="label.title.owner" /></label>
						<div class='col-xs-3'>
							<select name="owner">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" name='export' data-dismiss="modal">
