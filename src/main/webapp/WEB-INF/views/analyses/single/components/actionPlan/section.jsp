						...
						<table class="table table-hover table-condensed table-fixed-header-analysis" id="actionplantable_${apt}">
							<thead>
								<tr>
									...
									<th style="width:5%;" title='<fmt:message key="label.measure.norm" />' ><fmt:message key="label.measure.norm" /></th>
									<th style="width:5%;" title='<fmt:message key="label.reference" />' ><fmt:message key="label.reference" /></th>
									<th title='<fmt:message key="label.measure.todo" />' ><fmt:message key="label.measure.todo" /></th>
									<th style="width:2%;" title='<fmt:message key="label.title.ale" />' ><fmt:message key="label.action_plan.total_ale" /></th>
									<th style="width:2%;" title='<fmt:message key="label.title.delta_ale" />' ><fmt:message key="label.action_plan.delta_ale" /></th>
									<th style="width:2%;" title='<fmt:message key="label.title.measure.cost" />' ><fmt:message key="label.measure.cost" /></th>
									<th style="width:2%;" title='<fmt:message key="label.title.action_plan.roi" />' ><fmt:message key="label.action_plan.roi" /></th>
									<th style="width:2%;" title='<fmt:message key="label.title.measure.iw" />' ><fmt:message key="label.measure.iw" /></th>
									<th style="width:2%;" title='<fmt:message key="label.title.measure.ew" />' ><fmt:message key="label.measure.ew" /></th>
									<th style="width:2%;" title='<fmt:message key="label.title.measure.inv" />' ><fmt:message key="label.measure.inv" /></th>
									<th style="width:2%;" title='<fmt:message key="label.title.measure.phase" />' ><fmt:message key="label.measure.phase" /></th>
								</tr>
							</thead>
							<tbody>
