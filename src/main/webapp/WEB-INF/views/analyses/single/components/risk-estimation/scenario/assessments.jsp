						...
						<c:when test="${type == 'QUALITATIVE'}">
							<c:forEach items="${impactTypes}" var="impactType">
								...
								<c:choose>
									...
									<c:otherwise>
										<td data-trick-field="${impactName}" data-trick-field-type="string" class="success" title='<spring:message text="${impact.variable}"/>' onclick="return editField(this);"><c:choose>
							...
							<c:choose>
								<c:when test="${empty likelihood}">
									...
									<td data-trick-field="likelihood" data-trick-field-type="string" class="success" title='${likelihood}' onclick="return editField(this);"><spring:message
											code='label.status.na' /></td>
								</c:when>
								<c:otherwise>
									<td data-trick-field="likelihood" data-trick-field-type="string" class="success" onclick="return editField(this);" title='<spring:message text="${likelihood.variable}"/>'><c:choose>
