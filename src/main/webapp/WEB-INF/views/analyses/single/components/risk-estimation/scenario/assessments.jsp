...
<div class="col-md-10 trick-ui" id="section_scenario_assessment" data-view='estimation-ui' data-trick-asset-id='-1' data-trick-scenario-id='${scenario.id}' data-trick-content='scenario'>
