...
<div class="section col-lg-10 col-md-9 trick-ui" id="section_asset_assessment" data-view-type='table' data-view-name='estimation-ui' data-trick-asset-id='${asset.id}' data-trick-scenario-id='-1'
