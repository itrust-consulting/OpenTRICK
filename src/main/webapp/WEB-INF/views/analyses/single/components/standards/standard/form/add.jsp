...
<form name="standard" action="/Create?${_csrf.parameterName}=${_csrf.token}" class="form-horizontal" id="standard_form" method="post">
	...
	<div class="form-group">
		<label class="control-label col-sm-2" data-helper-content='<spring:message code="help.norm.type" />' ><spring:message code="label.norm.standard_type" /></label>
	...
	<div class="form-group">
		<label for="computable" class="col-sm-2 control-label" data-helper-content='<spring:message code="help.norm.computable" />' > <spring:message code="label.norm.computable" />
		</label>
	...
	<div class="form-group">
		<label for="description" class="col-sm-2 control-label" data-helper-content='<spring:message code="help.norm.description" />' > <spring:message code="label.norm.description" />
		</label>
		<div class="col-sm-10">
