					...
					<c:forEach items="${sortedAssessments}" var="assessment">
						<tr trick-class="Assessment" trick-id="${assessment.id}">
							...
							<c:choose>
								...
								<c:otherwise>
									<td trick-field="likelihood" trick-field-type="string" class="success" onclick="return editField(this);" real-value="${fct:round(assessment.likelihood,2)}"><c:catch>
							...
							<td class="success" onclick="return editField(this.firstChild);"><pre trick-field="comment" trick-field-type="string" trick-content="text"><spring:message
									text="${assessment.comment}" /></pre></td>
							<td class="success" onclick="return editField(this.firstChild);"><pre trick-field="hiddenComment" trick-content="text" trick-field-type="string"><spring:message
