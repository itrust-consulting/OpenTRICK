			...
			<div class="panel-body">
				<c:forEach items="${actionplansplitted.keySet()}" var="apt" varStatus="status">
					<div trick-nav-data="${apt}" ${status.index!=0? "hidden='true'" : "" }>
						<table class="table table-hover table-condensed" id="actionplantable_${apt}">
							<thead>
								<tr>
									<th style="width:3%;"><fmt:message key="label.table.index" /></th>
									<th style="width:5%;"><fmt:message key="label.measure.norm" /></th>
									<th style="width:5%;"><fmt:message key="label.measure.reference" /></th>
									<th style="width:47%;"><fmt:message key="label.action_plan.todo" /></th>
									<th style="width:5%;"><fmt:message key="label.action_plan.total_ale" /></th>
									<th style="width:5%;"><fmt:message key="label.action_plan.delta_ale" /></th>
									<th style="width:5%;"><fmt:message key="label.measure.cost" /></th>
									<th style="width:5%;"><fmt:message key="label.action_plan.roi" /></th>
									<th style="width:5%;"><fmt:message key="label.action_plan.internal_setup" /></th>
									<th style="width:5%;"><fmt:message key="label.action_plan.external_setup" /></th>
									<th style="width:5%;"><fmt:message key="label.action_plan.investment" /></th>
									<th style="width:5%;"><fmt:message key="label.action_plan.phase" /></th>
									...
									<c:forEach items="${actionplanassets}" var="asset">
										<th  style="width:5%;" class="actionplanasset actionplanassethidden"><spring:message text="${asset.name}" /></th>
									</c:forEach>
								</tr>
							</thead>
							<tbody>
