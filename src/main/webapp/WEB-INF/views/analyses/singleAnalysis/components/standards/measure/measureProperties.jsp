				...
				<table class="table" style="margin-bottom: 0;">
					...
					<tbody>
						<tr>
							...
							<td class="${cssclass} pdlc"><input type="text" id="measure_preventive" class="slider" value="${preventive}" data-slider-min="0" data-slider-max="1"
								data-slider-step="0.1" data-slider-value="${preventive}" data-slider-orientation="vertical" data-slider-selection="after" name="preventive" data-slider-tooltip="show"></td>
							<td class="${cssclass} pdlc"><input type="text" class="slider" id="measure_detective" value="${detective}" data-slider-min="0" data-slider-max="1"
								data-slider-step="0.1" data-slider-value="${detective}" name="detective" data-slider-orientation="vertical" data-slider-selection="after" data-slider-tooltip="show"></td>
							<td class="${cssclass} pdlc"><input type="text" id="measure_limitative" class="slider" value="${limitative}" data-slider-min="0" data-slider-max="1"
								data-slider-step="0.1" data-slider-value="${limitative}" data-slider-orientation="vertical" data-slider-selection="after" name="limitative" data-slider-tooltip="show"></td>
							<td class="${cssclass} pdlc"><input type="text" class="slider" id="measure_corrective" value="${corrective}" data-slider-min="0" data-slider-max="1"
								data-slider-step="0.1" data-slider-value="${corrective}" name="corrective" data-slider-orientation="vertical" data-slider-selection="after" data-slider-tooltip="show"></td>
						...
						<tr>
							...
							<c:if test="${!empty(assets)}">
								<c:forEach items="${assets}" var="asset">
									<td><input type="text" id='measure_<spring:message text="${asset.asset.name}"/>_value' style="min-width: 50px;" readonly="readonly" class="form-control"
