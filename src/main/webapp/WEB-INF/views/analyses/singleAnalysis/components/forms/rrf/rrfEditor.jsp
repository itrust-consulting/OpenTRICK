					...
					<div class="row" style="margin: 0;">
						<div class="col-md-4">
							...
							<div class="panel panel-primary" style="height: 390px; margin-bottom: -41px;">
								<div class="panel-body">
									<div class="list-group" style="max-height: 299px; overflow: auto;" id="selectable_rrf_measures_chapter_controls">
						...
						<div class="col-md-8">
							<div class="col-md-12" id="chart_rrf">
								<div style="width: 100%; height: 360px; padding-top: 180px">
													...
													<tr>
														...
														<c:forEach items="${categories.keySet()}" var="category">
															<td class="info" trick-class="Category" trick-value=<spring:message text="${category}"/>><input type="text" class="slider"
																id="measure_category_${fn:replace(category,'.','_')}" value="${categories.get(category)}" data-slider-min="0" data-slider-max="4" data-slider-step="4" data-slider-value="${categories.get(category)}"
														...
														<c:forEach items="${assetTypes}" var="assetType">
															<td trick-class="AssetType"><input type="text" class="slider" id='measure_assetType_<spring:message text="${assetType.assetType.type}"/>' value="${assetType.value}" data-slider-min="0"
																data-slider-max="100" data-slider-step="1" data-slider-value="${assetType.value}" name=<spring:message text="${assetType.assetType.type}"/> data-slider-orientation="vertical"
