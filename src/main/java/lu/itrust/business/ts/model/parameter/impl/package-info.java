/*@org.hibernate.annotations.AnyMetaDef(idType = "int", metaType = "string", name = "PARAMETER_META_DEF", metaValues = {
		@org.hibernate.annotations.MetaValue(targetEntity = lu.itrust.business.ts.model.parameter.impl.DynamicParameter.class, value = lu.itrust.business.ts.constants.Constant.PARAMETER_CATEGORY_DYNAMIC),
