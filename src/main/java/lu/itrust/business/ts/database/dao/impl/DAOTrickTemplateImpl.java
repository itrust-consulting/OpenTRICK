 ...
 */
@Repository
public class DAOTrickTemplateImpl extends DAOHibernate implements DAOTrickTemplate {

	public DAOTrickTemplateImpl() {
		super();
	}

	public DAOTrickTemplateImpl(Session session) {
		super(session);
	}
	...
	@Override
	public long count() {
		return createQueryWithCache("Select count(*) From TrickTemplate", Long.class).uniqueResult();
	}
	...
	public void delete(Long id) {
		createQuery("Delete TrickTemplate where id = :id", Integer.class).setParameter("id", id)
				.executeUpdate();
	}
	...
	public void deleteAll() {
		createQueryWithCache("Delete TrickTemplate",Integer.class).executeUpdate();
	}
	...
	public boolean exists(Long id) {
		return createQueryWithCache("Select count(*)> 0 From TrickTemplate where id = :id", Boolean.class)
	...
	public List<TrickTemplate> findAll() {
		return createQueryWithCache("From TrickTemplate", TrickTemplate.class).list();
	}
	...
	public List<TrickTemplate> findAll(List<Long> ids) {
		return ids.isEmpty() ? Collections.emptyList()
				: createQueryWithCache("From TrickTemplate where id in :ids", TrickTemplate.class)
	...
	public AnalysisType findTypeById(Long id) {
		return createQueryWithCache("Select type From TrickTemplate where id = :id", AnalysisType.class)
				.setParameter("id", id).uniqueResult();
	}
