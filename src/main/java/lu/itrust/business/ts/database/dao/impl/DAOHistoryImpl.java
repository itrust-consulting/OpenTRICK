 ...
 */
@Repository
public class DAOHistoryImpl extends DAOHibernate implements DAOHistory {

	/**
	 * Constructor: <br>
	 */
	public DAOHistoryImpl() {
	}
	 ...
	 * @param session
	 */
	public DAOHistoryImpl(Session session) {
		super(session);
	}
	...
	public History getFromAnalysisById(Integer idAnalysis, Integer idHistory)  {
		...
		return (History) createQueryWithCache(query).setParameter("idAnalysis", idAnalysis).setParameter("idHistory", idHistory).uniqueResultOptional().orElse(null);
	}
	...
	public boolean belongsToAnalysis(Integer analysisId, Integer historyId)  {
		...
		return (boolean) createQueryWithCache(query).setParameter("analysisId", analysisId).setParameter("historyId", historyId).getSingleResult();
	}
	...
	public List<History> getAll()  {
		return (List<History>) createQueryWithCache("From History").getResultList();
	}
	...
	public List<History> getAllFromAnalysis(Analysis analysis)  {
		return (List<History>) createQueryWithCache("From History where analysis = :analysis").setParameter("analysis", analysis).getResultList();
	}
