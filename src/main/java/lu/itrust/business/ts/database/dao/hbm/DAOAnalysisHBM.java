...
public class DAOAnalysisHBM extends DAOHibernate implements DAOAnalysis {
	...
	public boolean exists(Integer idAnalysis) {
		return (boolean) getSession().createQuery("Select count(*)> 0 From Analysis where id = :id")
	...
	public boolean exists(String identifier) {
		return (boolean) getSession()
				.createQuery("Select count(analysis) >0 From Analysis analysis where analysis.identifier = :identifier")
				.setParameter("identifier", identifier)
				.getSingleResult();
	}
	...
	public List<Analysis> getAll(List<Integer> ids) {
		return getSession().createQuery("From Analysis analysis where analysis.id in :analysisIds")
	...
	public List<Analysis> getAllByIdentifier(String identifier) {
		return getSession().createQuery("From Analysis analysis where analysis.identifier = :identifier")
	...
	public List<Analysis> getAllFromCustomer(Customer customer) {
		return (List<Analysis>) getSession().createQuery("From Analysis where customer = :customer")
	...
	public List<Analysis> getAllFromCustomer(Integer id) {
		return (List<Analysis>) getSession().createQuery("From Analysis where customer.id = :idCustomer")
	...
	public List<Analysis> getAllFromCustomerAndProfileByPageAndSizeIndex(Integer customerID, Integer pageIndex,
			Integer pageSize) {
		String query = "SELECT analysis From Analysis as analysis where analysis.customer.id = :customer OR analysis.profile=true";
		return (List<Analysis>) getSession().createQuery(query).setParameter("customer", customerID)
	...
	public List<Analysis> getAllFromCustomerIdentifierVersion(Customer customer, String identifier, String version) {
		...
		return (List<Analysis>) getSession().createQuery(query).setParameter("customer", customer)
	...
	public List<Analysis> getAllFromOwner(User user) {
		return getSession().createQuery("From Analysis where owner = :owner").setParameter("owner", user)
				.getResultList();
	}
	...
	public List<Analysis> getAllFromUserAndCustomer(String userName, Integer customerID) {
		...
		return getSession().createQuery(query).setParameter("username", userName).setParameter("customer", customerID)
				.getResultList();
	}
	...
	public List<Analysis> getAllFromUserAndCustomerByPageAndSizeIndex(String login, Integer customer, Integer pageIndex,
		...
		String query = "Select analysis from Analysis analysis join analysis.userRights userRight where userRight.user.login = :username and analysis.customer.id = :customer ";
		query += "order by analysis.creationDate desc, analysis.identifier asc, analysis.version desc, analysis.data desc";
		return getSession().createQuery(query).setParameter("username", login).setParameter("customer", customer)
	...
	public List<Analysis> getAllNotEmpty() {
		return getSession().createQuery("From Analysis analysis where analysis.empty = :empty")
	...
	public List<Analysis> getAllNotEmpty(int pageIndex, int pageSize) {
		return getSession().createQuery("From Analysis where data = true").setMaxResults(pageSize)
	...
	public List<Analysis> getAllNotEmptyFromUserAndCustomer(String userName, Integer idCustomer) {
		...
		return getSession().createQuery(query).setParameter("username", userName).setParameter("customer", idCustomer)
				.getResultList();
	}
	...
	public List<Analysis> getAllProfiles() {
		return getSession().createQuery("Select analysis From Analysis analysis where analysis.profile = true")
				.getResultList();
	}
	...
	public List<String> getAllProjectIds() {
		return getSession().createQuery("Select distinct project From Analysis where project IS NOT NULL")
				.getResultList();
	}
	...
	public AnalysisType getAnalysisTypeById(int idAnalysis) {
		return (AnalysisType) getSession().createQuery("Select type From Analysis where id = :idAnalysis")
	...
	public List<AnalysisBaseInfo> getBaseInfoByCustmerIdAndUsernamerAndIdentifierAndNotEmpty(Integer id,
		...
		return getSession().createQuery(query, Analysis.class).setParameter("username", username)
	...
	public Analysis getByCustomerAndNameAndVersion(int customerId, String name, String version) {
		return (Analysis) getSession()
				.createQuery("From Analysis where customer.id = :customerId and label = :name and version = :version")
	...
	public Analysis getByIdentifierAndVersion(String identifier, String version) {
		return (Analysis) getSession()
				.createQuery("from Analysis where identifier = :identifier and version = :version")
				.setParameter("identifier", identifier)
	...
	public Integer getCustomerIdByIdAnalysis(int idAnalysis) {
		return (Integer) getSession()
				.createQuery("select analysis.customer.id from Analysis as analysis where analysis.id = :idAnalysis")
	...
	public String getCustomerNameFromId(int idAnalysis) {
		return (String) getSession().createQuery("SELECT customer.organisation From Analysis where id = :id")
	...
	public Analysis getFromIdentifierVersionCustomer(String identifier, String version, Integer customerid) {
		...
		return getSession().createQuery(query, Analysis.class).setParameter("identifier", identifier)
	...
	public List<AnalysisBaseInfo> getGroupByIdentifierAndFilterByCustmerIdAndUsernamerAndNotEmpty(Integer id,
		...
		return getSession().createQuery(query, Analysis.class).setParameter("type", type)
				.setParameter("username", username).setParameterList("rights", rights)
	...
	public String getIdentifierByIdAnalysis(int idAnalysis) {
		return (String) getSession()
				.createQuery("select analysis.identifier from Analysis as analysis where analysis.id = :idAnalysis")
				.setParameter("idAnalysis", idAnalysis)
				.uniqueResultOptional().orElse(null);
	}
	...
	public Integer getIdFromIdentifierAndVersion(String identifier, String version) {
		return (Integer) getSession()
				.createQuery("select id from Analysis where identifier = :identifier and version = :version")
				.setParameter("identifier", identifier)
	...
	public String getLabelFromId(int idAnalysis) {
		return (String) getSession().createQuery("SELECT label From Analysis where id = :id")
				.setParameter("id", idAnalysis).uniqueResultOptional().orElse(null);
	}
	...
	public Language getLanguageOfAnalysis(Integer analysisID) {
		return (Language) getSession()
				.createQuery("SELECT language FROM Analysis analysis WHERE analysis.id = :analysisID")
	...
	public List<String> getNotProfileIdentifiers(int page, int size) {
		return getSession().createQuery("Select distinct identifier From Analysis where  profile = false")
	...
	public IParameter getParameterFromAnalysis(Integer idAnalysis, String Parameter) {
		...
		return (IParameter) getSession().createQuery(query).setParameter("idAnalysis", idAnalysis)
	...
	public Analysis getProfileByName(String name) {
		return (Analysis) getSession().createQuery("from Analysis where label = :name and profile = true")
	...
	public String getProjectIdById(Integer idAnalysis) {
		return (String) getSession().createQuery("Select project From Analysis where id = :idAnalysis")
	...
	public String getVersionOfAnalysis(Integer id) {
		return (String) getSession().createQuery("SELECT version From Analysis where id = :id").setParameter("id", id)
				.uniqueResultOptional().orElse(null);
	}
	...
	public boolean hasData(Integer idAnalysis) {
		return (boolean) getSession()
				.createQuery("Select analysis.data From Analysis analysis where analysis.id = :identifier")
	...
	public boolean hasData(String identifier) {
		return (boolean) getSession()
				.createQuery("Select count(*) > 0 From Analysis where identifier = :identifier and data = true")
				.setParameter("identifier", identifier)
				.getSingleResult();
	}
	...
	public boolean isAnalysisCustomer(int idAnalysis, int idCustomer) {
		return (boolean) getSession()
				.createQuery("Select count(*)> 0 From Analysis where id = :idAnalysis and customer.id = :idCustomer")
				.setParameter("idAnalysis", idAnalysis)
	...
	public boolean isAnalysisUncertainty(Integer analysisID) {
		...
		return (boolean) getSession().createQuery(query).setParameter("id", analysisID).uniqueResultOptional()
				.orElse(false);
	}
	...
	public boolean isProfile(Integer analysisid) {
		return (boolean) getSession()
				.createQuery("Select analysis.profile From Analysis analysis where analysis.id = :analysisid")
				.setParameter("analysisid", analysisid)
				.uniqueResultOptional().orElse(false);
	...
	public boolean isProfileNameInUsed(String name) {
		return (boolean) getSession()
				.createQuery("Select count(*)>0 From Analysis where profile = true and label = :name")
	...
	private void deleteActionPlanByAnalysisId(Integer analysisID) {
		...
		List<ActionPlanEntry> actionplans = getSession().createQuery(query, ActionPlanEntry.class)
				.setParameter("analysisID", analysisID).getResultList();
	...
	private void deleteActionPlanSummaryByAnalysisId(Integer analysisID) {
		...
		List<SummaryStage> summaries = (List<SummaryStage>) getSession().createQuery(query)
	...
	public Analysis findByIdAndCustomer(Integer id, Customer customer) {
		return getSession()
				.createQuery("From Analysis analysis where analysis.id = :id and analysis.customer = :customer",
						Analysis.class)
