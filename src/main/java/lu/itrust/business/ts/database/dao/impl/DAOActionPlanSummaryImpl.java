...
/**
 * DAOActionPlanSummaryImpl.java: <br>
 ...
 */
@Repository
public class DAOActionPlanSummaryImpl extends DAOHibernate implements DAOActionPlanSummary {

	/**
	 * Constructor: <br>
	 */
	public DAOActionPlanSummaryImpl() {
	}
	 ...
	 * @param session
	 */
	public DAOActionPlanSummaryImpl(Session session) {
		super(session);
	}
	...
	public SummaryStage getFromAnalysisById(Integer idAnalysis, Integer idSummaryStage)  {
		...
		return (SummaryStage) createQueryWithCache(query).setParameter("idAnalysis", idAnalysis).setParameter("idSummaryStage", idSummaryStage).uniqueResultOptional().orElse(null);
	}
	...
	public boolean belongsToAnalysis(Integer analysisId, Integer actionPlanSummaryId)  {
		...
		return (boolean) createQueryWithCache(query).setParameter("analysisId", analysisId).setParameter("actionPlanSummaryId", actionPlanSummaryId).getSingleResult();
	}
	...
	public List<SummaryStage> getAll()  {
		return createQueryWithCache("From SummaryStage").getResultList();
	}
	...
	public List<SummaryStage> getAllFromAnalysisAndActionPlanType(Integer idAnalysis, String actionPlanType)  {
		...
		return createQueryWithCache(query).setParameter("idAnalysis", idAnalysis).setParameter("actionPlanType", ActionPlanMode.getByName(actionPlanType)).getResultList();
	}
	...
	public void deleteAllFromAnalysis(Integer analysisID)  {
		...
		List<SummaryStage> summaries = (List<SummaryStage>) createQueryWithCache(query).setParameter("idAnalysis", analysisID).getResultList();
