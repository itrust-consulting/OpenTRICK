...
public class CustomerValidator extends ValidatorFieldImpl implements Validator {
	...
	public void validate(Object arg0, Errors arg1) {
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(arg1, "phone_number", "error.customer.phone_number.empty", "Phone Number cannot be empty");
		ValidationUtils.rejectIfEmptyOrWhitespace(arg1, "email", "error.customer.email.empty", "Email address cannot be empty");
