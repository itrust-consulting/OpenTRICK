	...
	public String validate(Object o, String fieldName, Object candidate) {
		...
		switch (fieldName) {
			...
			case "ALEP":
				...
				if (ale < 0)
					return "error.assessment.negatif.value:" + fieldName + ":" + fieldName + " needs to be greater or equal 0";
				break;
			case "uncertainty":
				if (candidate == null || !(candidate instanceof Double))
					return "error.assessment.invalid.value:" + fieldName + ":" + fieldName + " should be a numeric";
				...
				if (uncertainty <= 1)
					return "error.assessment.uncertainty.less_one:" + fieldName + ":" + fieldName + " needs to be greater than 1";
				break;
			case "likelihoodReal":
				if (candidate == null || !(candidate instanceof Double))
					return "error.assessment.invalid.value:" + fieldName + ":" + fieldName + " should be a numeric";
