...
public class MeasureValidator extends ValidatorFieldImpl {
	...
	protected static final String ERROR_UNSUPPORTED_DATA_ANALYSIS_NORM_ANALYSIS_NORM_VALUE_IS_NOT_SUPPORTED = "error.unsupported.data.analysis_norm::Analysis norm value is not supported";
	...
	protected static final String ERROR_UNSUPPORTED_DATA_MEASURE_DESCRIPTION_MEASURE_DESCRIPTION_VALUE_IS_NOT_SUPPORTED = "error.unsupported.data.measure_description::Measure description value is not supported";
	...
	protected static final String ERROR_UNSUPPORTED_DATA_PHASE_PHASE_VALUE_IS_NOT_SUPPORTED = "error.unsupported.data.phase::Phase value is not supported";
	protected static final String ERROR_UNSUPPORTED_DATA_STATUS_STATUS_VALUE_IS_NOT_SUPPORTED = "error.unsupported.data.status::Status value is not supported";
	...
	protected static final String ERROR_UNSUPPORTED_DATA_INTERNAL_WL_INTERNAL_WORKLOAD_VALUE_IS_NOT_SUPPORTED = "error.unsupported.data.internal_wl::Internal workload value is not supported";
	...
	protected static final String ERROR_UNSUPPORTED_DATA_EXTERNAL_WL_EXTERNAL_WORKLOAD_VALUE_IS_NOT_SUPPORTED = "error.unsupported.data.external_wl::External workload value is not supported";
	...
	protected static final String ERROR_UNSUPPORTED_DATA_INVESTMENT_INVESTMENT_VALUE_IS_NOT_SUPPORTED = "error.unsupported.data.investment::Investment value is not supported";
	...
	protected static final String ERROR_UNSUPPORTED_DATA_LIFETIME_LIFETIME_VALUE_IS_NOT_SUPPORTED = "error.unsupported.data.lifetime::Lifetime value is not supported";
	...
	protected static final String ERROR_UNSUPPORTED_DATA_MAINTENANCE_MAINTENANCE_VALUE_IS_NOT_SUPPORTED = "error.unsupported.data.maintenance::Maintenance value is not supported";
	...
	protected static final String ERROR_UNSUPPORTED_DATA_COST_COST_VALUE_IS_NOT_SUPPORTED = "error.unsupported.data.cost::Cost value is not supported";
	...
	protected static final String ERROR_UNSUPPORTED_DATA_COMMENT_COMMENT_VALUE_IS_NOT_SUPPORTED = "error.unsupported.data.comment::Comment value is not supported";
	protected static final String ERROR_UNSUPPORTED_DATA_TO_DO_TO_DO_VALUE_IS_NOT_SUPPORTED = "error.unsupported.data.to_do::To do value is not supported";
	...
	public String validate(Object o, String fieldName, Object candidate) {
		...
		case STATUS:
			...
			if (stringCandidate == null || stringCandidate.trim().isEmpty())
		...
		case MAINTENANCE:
			...
			doubleCanditate = (Double) candidate;
			if (doubleCanditate == null || doubleCanditate < 0 && doubleCanditate != -1)
