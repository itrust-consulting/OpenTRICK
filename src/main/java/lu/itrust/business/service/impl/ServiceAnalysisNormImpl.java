...
public class ServiceAnalysisNormImpl implements ServiceAnalysisNorm {
	 ...
	 * 
	 * @see
	 * lu.itrust.business.service.ServiceAnalysisNorm#loadAllFromAnalysis(lu.itrust.business.TS.
	 * Analysis)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * lu.itrust.business.service.ServiceAnalysisNorm#loadAllFromNorm(lu.itrust.business.TS.Norm)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * lu.itrust.business.service.ServiceAnalysisNorm#saveOrUpdate(lu.itrust.business.TS.AnalysisNorm
	 * )
	 */
	@Transactional
	@Override
	 ...
	 * 
	 * @see
	 * lu.itrust.business.service.ServiceAnalysisNorm#remove(lu.itrust.business.TS.AnalysisNorm)
	 */
	@Transactional
	@Override
	...
	/**
	 * @param daoAnalysisNorm
	 *            the daoAnalysisNorm to set
	 */
	...
	public List<AnalysisNorm> loadAllFromAnalysis(Integer analysisID) throws Exception {
		return this.daoAnalysisNorm.loadAllFromAnalysis(analysisID);
	}
