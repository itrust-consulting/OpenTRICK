...
public class ControllerEditField {
	...
	public @ResponseBody
	String extendedParameter(@RequestBody FieldEditor fieldEditor, HttpSession session, Locale locale) {
		try {
	...
	public @ResponseBody
	String measure(@RequestBody FieldEditor fieldEditor, HttpSession session, Locale locale) {
		try {
	...
	public @ResponseBody
	String maturityMeasure(@RequestBody FieldEditor fieldEditor, HttpSession session, Locale locale) {
		try {
	...
	public @ResponseBody
	String actionplanentry(@RequestBody FieldEditor fieldEditor, HttpSession session, Locale locale) {
		try {
			Integer idAnalysis = (Integer) session.getAttribute("selectedAnalysis");
	...
	public @ResponseBody
	String phase(@RequestBody FieldEditor fieldEditor, HttpSession session, Locale locale) {
		try {
