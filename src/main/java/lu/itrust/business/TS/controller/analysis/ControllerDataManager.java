	...
	public String exportReportForm(Model model, HttpSession session, Principal principal, Locale locale) {
		...
		if (analysis.isHybrid())
			model.addAttribute("items",
					new DataManagerItem[] { new DataManagerItem(AnalysisType.QUANTITATIVE.name(), "/Analysis/Data-manager/Report/Export-process", ".docx"),
							new DataManagerItem(AnalysisType.HYBRID.name(), "/Analysis/Data-manager/Report/Export-process", ".docx"),
