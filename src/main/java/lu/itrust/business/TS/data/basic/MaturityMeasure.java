...
public class MaturityMeasure extends Measure implements Cloneable {
	 ...
	 * @throws TrickException
	 * @see lu.itrust.business.TS.data.basic.Measure#setImplementationRate(Object)
	 */
	@Override
	 ...
	 * @{tags
	 *
	 * @see lu.itrust.business.TS.data.basic.Measure#duplicate(lu.itrust.business.TS.data.basic.AnalysisStandard)
	 */
	@Override
