...
public class Scenario extends SecurityCriteria {
	 ...
	 * @throws TrickException
	 * @see lu.itrust.business.TS.data.basic.SecurityCriteria#setPreventive(double)
	 */
	@Override
	 ...
	 * @throws TrickException
	 * @see lu.itrust.business.TS.data.basic.SecurityCriteria#setDetective(double)
	 */
	@Override
	 ...
	 * @throws TrickException
	 * @see lu.itrust.business.TS.data.basic.SecurityCriteria#setLimitative(double)
	 */
	@Override
	 ...
	 * @throws TrickException
	 * @see lu.itrust.business.TS.data.basic.SecurityCriteria#setCorrective(double)
	 */
	@Override
	 ...
	 * @throws TrickException
	 * @see lu.itrust.business.TS.data.basic.SecurityCriteria#setIntentional(int)
	 */
	@Override
	 ...
	 * @throws TrickException
	 * @see lu.itrust.business.TS.data.basic.SecurityCriteria#setAccidental(int)
	 */
	@Override
	 ...
	 * @throws TrickException
	 * @see lu.itrust.business.TS.data.basic.SecurityCriteria#setEnvironmental(int)
	 */
	@Override
	 ...
	 * @throws TrickException
	 * @see lu.itrust.business.TS.data.basic.SecurityCriteria#setInternalThreat(int)
	 */
	@Override
	 ...
	 * @throws TrickException
	 * @see lu.itrust.business.TS.data.basic.SecurityCriteria#setExternalThreat(int)
	 */
	@Override
	 ...
	 * @see lu.itrust.business.TS.data.basic.SecurityCriteria#isValidValue(int)
	 */
	@Override
	 ...
	 * @{tags
	 *
	 * @see lu.itrust.business.TS.data.basic.SecurityCriteria#duplicate()
	 */
	 ...
	 * @{tags
	 *
	 * @see lu.itrust.business.TS.data.basic.SecurityCriteria#valueFixer(java.lang.String, int)
	 */
	@Override
