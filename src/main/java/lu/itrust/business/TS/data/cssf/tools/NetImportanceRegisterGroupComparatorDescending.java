 ...
 * This class is used inside the Collections class as algorithm to decide on Descending comparation.
 * 
 * @author itrust consulting s.�.rl. : BJA, EOM, SME
 * @version 0.1
 * @since 27 d�c. 2012
 */
public class NetImportanceRegisterGroupComparatorDescending implements Comparator<RiskRegisterItemGroup> {
	...
	public int compare(RiskRegisterItemGroup o1, RiskRegisterItemGroup o2) {
		...
		double value1 = o1.getNetImportance();

		// retrieve importance value of second item
		double value2 = o2.getNetImportance();
