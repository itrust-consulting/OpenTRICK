...
public class AssetMeasure extends Measure implements Cloneable {
	 ...
	 * @see lu.itrust.business.TS.data.basic.Measure#getImplementationRate()
	 */
	@Override
	 ...
	 * 
	 * @return Implementation Rate Value
	 * @see lu.itrust.business.TS.data.basic.Measure#getImplementationRateValue()
	 * @see lu.itrust.business.TS.data.basic.NormalMeasure#getImplementationRate()
	 */
	@Override
	@Transient
	 ...
	 * @throws TrickException
	 * @see lu.itrust.business.TS.data.basic.Measure#setImplementationRate(java.lang.Object)
	 */
	@Override
	 ...
	 * @{tags
	 *
	 * @see lu.itrust.business.TS.data.basic.Measure#clone()
	 */
	@Override
	 ...
	 * @{tags
	 *
	 * @see lu.itrust.business.TS.data.basic.Measure#duplicate()
	 */
	@Override
