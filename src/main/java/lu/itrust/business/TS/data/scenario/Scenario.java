...
public class Scenario extends SecurityCriteria {
	 ...
	 * @throws TrickException
	 * @see lu.itrust.business.TS.data.general.SecurityCriteria#setPreventive(double)
	 */
	@Override
	 ...
	 * @throws TrickException
	 * @see lu.itrust.business.TS.data.general.SecurityCriteria#setDetective(double)
	 */
	@Override
	 ...
	 * @throws TrickException
	 * @see lu.itrust.business.TS.data.general.SecurityCriteria#setLimitative(double)
	 */
	@Override
	 ...
	 * @throws TrickException
	 * @see lu.itrust.business.TS.data.general.SecurityCriteria#setCorrective(double)
	 */
	@Override
	 ...
	 * @throws TrickException
	 * @see lu.itrust.business.TS.data.general.SecurityCriteria#setIntentional(int)
	 */
	@Override
	 ...
	 * @throws TrickException
	 * @see lu.itrust.business.TS.data.general.SecurityCriteria#setAccidental(int)
	 */
	@Override
	 ...
	 * @throws TrickException
	 * @see lu.itrust.business.TS.data.general.SecurityCriteria#setEnvironmental(int)
	 */
	@Override
	 ...
	 * @throws TrickException
	 * @see lu.itrust.business.TS.data.general.SecurityCriteria#setInternalThreat(int)
	 */
	@Override
	 ...
	 * @throws TrickException
	 * @see lu.itrust.business.TS.data.general.SecurityCriteria#setExternalThreat(int)
	 */
	@Override
	 ...
	 * @see lu.itrust.business.TS.data.general.SecurityCriteria#isValidValue(int)
	 */
	@Override
	 ...
	 * @{tags
	 *
	 * @see lu.itrust.business.TS.data.general.SecurityCriteria#duplicate()
	 */
	 ...
	 * @{tags
	 *
	 * @see lu.itrust.business.TS.data.general.SecurityCriteria#valueFixer(java.lang.String, int)
	 */
	@Override
