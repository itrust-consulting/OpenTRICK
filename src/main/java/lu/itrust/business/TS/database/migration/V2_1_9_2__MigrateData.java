...
public class V2_1_9_2__MigrateData extends TrickServiceDataBaseMigration {
	...
	private void updateQualitativeAssessments(JdbcTemplate template, Integer idAnalysis, Map<String, Map<String, IBoundedParameter>> paramters, ValueFactory valueFactory) {
		...
		for (AssessmentMapper assessmentMapper : assessmentMappers) {
			IValue likelihood = findValue(assessmentMapper.getLikelihood(), likelihoods, valueFactory, Constant.PARAMETERTYPE_TYPE_PROPABILITY_NAME),
					...
					reputational = findValue(assessmentMapper.getReputational(), reputationals, valueFactory, Constant.DEFAULT_IMPACT_TYPE_NAMES[3]);
	...
	private void updateQuantitativeAssessments(JdbcTemplate template, Integer idAnalysis, Map<String, Map<String, IBoundedParameter>> paramters) {
