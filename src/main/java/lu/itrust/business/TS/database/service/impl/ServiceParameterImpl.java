...
public class ServiceParameterImpl implements ServiceParameter {
	 ...
	 * @throws Exception
	 * 
	 * @see lu.itrust.business.TS.database.service.ServiceParameter#save(lu.itrust.business.TS.data.basic.Parameter)
	 */
	@Transactional
	@Override
	 ...
	 * @throws Exception
	 * 
	 * @see lu.itrust.business.TS.database.service.ServiceParameter#saveOrUpdate(lu.itrust.business.TS.data.basic.Parameter)
	 */
	@Transactional
	@Override
	 ...
	 * @throws Exception
	 * 
	 * @see lu.itrust.business.TS.database.service.ServiceParameter#merge(lu.itrust.business.TS.data.basic.Parameter)
	 */
	@Transactional
	@Override
	 ...
	 * @throws Exception
	 * 
	 * @see lu.itrust.business.TS.database.service.ServiceParameter#delete(lu.itrust.business.TS.data.basic.Parameter)
	 */
	@Transactional
	@Override
