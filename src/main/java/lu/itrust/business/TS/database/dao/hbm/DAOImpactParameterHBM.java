 ...
 */
@Repository
public class DAOImpactParameterHBM extends DAOHibernate implements DAOImpactParameter {

	/**
	 * 
	 */
	public DAOImpactParameterHBM() {
	}

	/**
	 * @param session
	 */
	public DAOImpactParameterHBM(Session session) {
		super(session);
	}
