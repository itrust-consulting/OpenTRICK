...
public class ServiceTrickServiceImpl implements ServiceTrickService {
	 ...
	 * @throws Exception
	 * 
	 * @see lu.itrust.business.TS.database.service.ServiceTrickService#save(lu.itrust.business.TS.data.basic.TrickService)
	 */
	@Transactional
	@Override
	 ...
	 * @throws Exception
	 * 
	 * @see lu.itrust.business.TS.database.service.ServiceTrickService#saveOrUpdate(lu.itrust.business.TS.data.basic.TrickService)
	 */
	@Transactional
	@Override
	 ...
	 * @throws Exception
	 * 
	 * @see lu.itrust.business.TS.database.service.ServiceTrickService#delete(lu.itrust.business.TS.data.basic.TrickService)
	 */
	@Transactional
	@Override
