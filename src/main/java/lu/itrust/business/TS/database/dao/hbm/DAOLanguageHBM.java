...
public class DAOLanguageHBM extends DAOHibernate implements DAOLanguage {
	 ...
	 * Description
	 * 
	 * @see lu.itrust.business.TS.database.dao.DAOLanguage#save(lu.itrust.business.TS.data.basic.Language)
	 */
	@Override
	 ...
	 * Description
	 * 
	 * @see lu.itrust.business.TS.database.dao.DAOLanguage#saveOrUpdate(lu.itrust.business.TS.data.basic.Language)
	 */
	@Override
	 ...
	 * Description
	 * 
	 * @see lu.itrust.business.TS.database.dao.DAOLanguage#delete(lu.itrust.business.TS.data.basic.Language)
	 */
	@Override
