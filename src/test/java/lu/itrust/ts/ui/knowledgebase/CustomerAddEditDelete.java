...
public class CustomerAddEditDelete extends BaseUnitTesting {
	...
	public void addCustomer(String organisation, String contactPerson, String phoneNumber, String email, String ZIPCode, String city, String country, String address)
	...
	public void updateCustomer(String updateThisOrganisation, String organisation, String contactPerson, String phoneNumber, String email, String ZIPCode, String city,
			String country, String address) throws InterruptedException {
		goTabCustomers();
		// update
	...
	private void fillForm(String organisation, String contactPerson, String phoneNumber, String email, String ZIPCode, String city, String country, String address) {
	...
	private void selectCheckBoxCustomer(String customer) throws InterruptedException {
		selectCheckBox(true, By.xpath("//div[@id='section_customer']//td[@data-trick-name='organisation'][ text() = '" + customer + "']/..//input"));
	}
}
